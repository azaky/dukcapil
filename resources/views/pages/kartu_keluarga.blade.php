        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4"><label>Akta Lahir</label><input class="form-control" placeholder="Kode Akta Lahir"></div>
                        </div>
                        <div class="row">
                            <div class="col-xs-4"><label>NIK Ayah</label><input class="form-control" placeholder="NIK Ayah"></div>
                            <div class="col-xs-4"><label>NIK Ibu</label><input class="form-control" placeholder="NIK Ibu"></div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6"><label>Kelainan Fisik</label><textarea class="form-control" placeholder="Kelainan Fisik"></textarea></div>
                        </div>
                    </div>
                </div>
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-4"><label>Pendidikan Terakhir</label><input class="form-control" placeholder="Pendidikan Terakhir"></div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4"><label>Akta Perkawinan</label><input class="form-control" placeholder="Kode Akta Perkawinan"></div>
                            <div class="col-xs-4"><label>Akta Penceraian</label><input class="form-control" placeholder="Kode Akta Penceraian"></div>
                        </div>
                    </div>
                </div>
            </div>
