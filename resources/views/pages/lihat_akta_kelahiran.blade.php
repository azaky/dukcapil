            ...
            <div class="panel-body">
                <ul class="list-group">
                    <li class="list-group-item">
                        ...
                        <div class="col-xs-9">: {{ sprintf('%010d', $aktalahir->id) }}</div>
                    </li>
                </ul>
                <ul class="list-group">
                    <li class="list-group-item">
                        <div class="col-xs-3">Nama Lengkap</div>
                        <div class="col-xs-9">: {{ $penduduk->nama }}</div>
                    </li>
                </ul>
                <ul class="list-group">
                    <li class="list-group-item">
                        <div class="col-xs-3">Tempat lahir</div>
                        <div class="col-xs-9">: {{ $penduduk->tempatLahir }}</div>
                    </li>
                </ul>
                <ul class="list-group">
                    <li class="list-group-item">
                        <div class="col-xs-3">Waktu lahir</div>
                        <div class="col-xs-9">: {{ $penduduk->waktuLahir }}</div>
                    </li>
                </ul>
            </div>
        </div>
